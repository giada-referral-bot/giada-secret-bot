...
def share_link(user_id):
    ...
    text = (
        "💋 **GIADA SECRET** 💋\n\n"
        "Ti aspettano **foto, video e contenuti esclusivi** di Giada GRATIS.\n\n"
        "🔐 **Premi il link per accedere** 🔐"
    )
    return (
...
async def send_invitation_card(chat_id, context, user_id):
    ...
    text = (
        "💋 <b>GIADA SECRET</b> 🐷\n\n"
        "Vuoi scoprire <b>foto, video e contenuti esclusivi</b> di Giada?\n\n"
        "🔐 <a href=\"{link}\"><b>ACCEDI A GIADA</b></a>\n\n"
    ...
    await context.bot.send_message(
        chat_id,
        "📸 Questo è il tuo invito pronto da inoltrare. "
        "Puoi tenere premuto sul messaggio con la foto e inoltrarlo alla persona che vuoi invitare.",
    )
